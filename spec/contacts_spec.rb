...
describe('Contacts') do
  ...
  describe("#first_name") do
    it("returns the first name of person") do
      test_contact = Contacts.new({:first_name => "Susan", :last_name => "Jones", :title => "Analyst", :phone => [703, 5039874, "home" ], :company => "Apple", :email =>["www.google.com", "home"],:address =>["107 Cherry Lane", "Wonderland", "Colorado", 11111, "home"]})
  ...
  describe('#mail') do
    it("returns mailing address info") do
      test_contact = Contacts.new({:first_name => "Michael", :last_name => "Summers", :title => "student", :company => "Epicodus", :phone => [703, 5039874, "home" ], :email =>["www.google.com", "home"], :address =>["107 Cherry Lane", "Wonderland", "Colorado", 11111, "home"]})
    end
  end
